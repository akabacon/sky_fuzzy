...
def Fuzzy_Controller(V1,V2): # V1：delta_x，V2：delta_phi
    ...
    delta_phi['A_R']=skfuzzy.trimf(universe_delta_phi,[-90,-45,0]) #0~90
    delta_phi['A_M']=skfuzzy.trimf(universe_delta_phi,[-45,0,45])
    delta_phi['A_L']=skfuzzy.trimf(universe_delta_phi,[0,45,90])

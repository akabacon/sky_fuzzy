...
def Fuzzy_Controller(V1,V2,V3): # V1：delta_x，V2：delta_phi ，delta_y
    ...
    delta_phi['A_SN']=skfuzzy.trapmf(universe_delta_phi,[-90,-90,-60,-30])
    delta_phi['A_N']=skfuzzy.trimf(universe_delta_phi,[-60,-30,0])
    delta_phi['A_M']=skfuzzy.trimf(universe_delta_phi,[-30,0,30])
    delta_phi['A_P']=skfuzzy.trimf(universe_delta_phi,[0,30,60])
    delta_phi['A_SP']=skfuzzy.trapmf(universe_delta_phi,[30,60,90,90])
    ...
    rope1=(delta_x['C_SL']&delta_phi['A_SN'])
    rope2=(delta_x['C_L']&delta_phi['A_SN'])|(delta_x['C_SL']&delta_phi['A_N'])
    rope3=(delta_x['C_M']&delta_phi['A_SN'])|(delta_x['C_L']&delta_phi['A_N'])|(delta_x['C_SL']&delta_phi['A_P'])
    rope4=(delta_x['C_R']&delta_phi['A_SN'])|(delta_x['C_M']&delta_phi['A_N'])|(delta_x['C_L']&delta_phi['A_M'])|(delta_x['C_SL']&delta_phi['A_P'])
    rope5=(delta_x['C_SR']&delta_phi['A_SN'])|(delta_x['C_R']&delta_phi['A_N'])|(delta_x['C_M']&delta_phi['A_M'])|(delta_x['C_L']&delta_phi['A_P'])|(delta_x['C_SL']&delta_phi['A_SP'])
    rope6=(delta_x['C_SR']&delta_phi['A_N'])|(delta_x['C_R']&delta_phi['A_M'])|(delta_x['C_M']&delta_phi['A_P'])|(delta_x['C_L']&delta_phi['A_SP'])
    rope7=(delta_x['C_SR']&delta_phi['A_M'])|(delta_x['C_R']&delta_phi['A_P'])|(delta_x['C_M']&delta_phi['A_SP'])
    rope8=(delta_x['C_SR']&delta_phi['A_P'])|(delta_x['C_R']&delta_phi['A_SP'])
    rope9=(delta_x['C_SR']&delta_phi['A_SP'])
